...
def limpiar_input(user_input):
    ...
    palabras_prohibidas = [r'DATABASE', r'base de datos', r'SQL', r'SELECT', r'UPDATE', r'GET', r'DELETE', r'POST', r'PUT', r'TABLE', r'GROUP BY', r'ORDER BY', r'INSERT', r'mysql',r'mongodb', r'mongoose', r'mongo', r'password', r'username', r'user', r'pass', r'root', r'admin', r'contraseña']
